<div class="col-md-4 about-right heading">
					<div class="abt-1">
						<h3>ABOUT US</h3>
						<div class="abt-one">
							<img src="<?php echo get_theme_file_uri();?>/assetes/images/c-2.jpg" alt="" />
						...
						<h3>YOU MIGHT ALSO LIKE</h3>
							<div class="might-grid">
								<div class="grid-might">
									<a href="single.html"><img src="<?php echo get_theme_file_uri();?>/assetes/images/c-12.jpg" class="img-responsive" alt=""> </a>
								</div>
								<div class="might-top">
							...
							<div class="might-grid">
								<div class="grid-might">
									<a href="single.html"><img src="<?php echo get_theme_file_uri();?>/assetes/images/c-10.jpg" class="img-responsive" alt=""> </a>
								</div>
								<div class="might-top">
									<h4><a href="single.html">Duis consectetur gravida</a></h4>
									<p> Nullam non magna lobortis, faucibus erat eu, consequat justo. Suspendisse commodo nibh odio.</p> 
							...
							<div class="might-grid">
								<div class="grid-might">
									<a href="single.html"><img src="<?php echo get_theme_file_uri();?>/assetes/images/c-11.jpg" class="img-responsive" alt=""> </a>
								</div>
								<div class="might-top">
									<h4><a href="single.html">Duis consectetur gravida</a></h4>
									<p> Nullam non magna lobortis, faucibus erat eu, consequat justo. Suspendisse commodo nibh odio.</p> 
